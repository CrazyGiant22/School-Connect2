...
<header class="header d-flex justify-content-between align-items-center px-3 py-2 bg-primary text-white">
    <div class="d-flex align-items-center">
        ...
        <a href="#" class="text-white text-decoration-none fw-bold fs-5">Student Dashboard</a>
    </div>
...
<aside id="sidebar" class=" border-end">
    <ul class="list-unstyled m-0 p-3">
        <li class="mb-2">
            <a href="student_profile.php" class="d-block py-2 px-3 rounded text-white fw-semibold hover-link">My Profile</a>
        </li>
        <li class="mb-2">
            <a href="student_courses.php" class="d-block py-2 px-3 rounded text-white fw-semibold hover-link">My Courses</a>
        </li>
        <li class="mb-2">
